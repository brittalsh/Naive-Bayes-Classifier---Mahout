...
/*
 * This class is used to generate test data which appear both in lemma_index and in professions
 */

public class preprocess3 {
	
	public static class Preprocess3Mapper extends Mapper<LongWritable, Text, Text, Text> {
